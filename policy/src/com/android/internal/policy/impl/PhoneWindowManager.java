...
public class PhoneWindowManager implements WindowManagerPolicy {
    ...
    public int finishPostLayoutPolicyLw() {
        ...
        if (mStatusBar != null) {
            ...
            if (mForceStatusBar || mForceStatusBarFromKeyguard) {
                ...
                // case though.
                if (topIsFullscreen || Settings.System.getInt(mContext.getContentResolver(), Settings.System.STATUSBAR_HIDDEN, 0) == 1) {
   ...
   public void takeScreenshot() {
    ...
    public int interceptMotionBeforeQueueingWhenScreenOff(int policyFlags) {
        int result = 0;
        boolean lTrackballWakeScreen = true;
        ...
        // devices ability to wake the device.
            || ((policyflag == 3) && lTrackballWakeScreen);
        if (isWakeMotion) {
